    ...
    <div className="flex flex-col gap-8 animate-slide-up">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {isDirection ? (
          ...
          <>
            <div className="bg-white rounded-xl border border-border p-6 shadow-sm flex flex-col gap-3 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-md border-t-4 border-t-primary">
              <div className="flex justify-between items-start gap-2">
                <span className="text-[0.85rem] font-bold text-text-muted uppercase tracking-wider leading-tight">Total Alumnos Matriculados</span>
                <span className="text-[0.75rem] font-bold py-0.5 px-1.5 rounded bg-emerald-100 text-emerald-600">↑ 8.5%</span>
              </div>
              <div className="font-heading text-[2.25rem] font-extrabold text-text-heading leading-none">1,248</div>
              <p className="text-[0.78rem] text-text-muted leading-relaxed">Estudiantes con matrícula aprobada en el periodo 2026-I.</p>
            </div>
            
            <div className="bg-white rounded-xl border border-border p-6 shadow-sm flex flex-col gap-3 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-md border-t-4 border-t-accent">
              <div className="flex justify-between items-start gap-2">
                <span className="text-[0.85rem] font-bold text-text-muted uppercase tracking-wider leading-tight">Validaciones Pendientes</span>
                <span className="text-[0.75rem] font-bold py-0.5 px-1.5 rounded bg-red-100 text-red-600">↓ 15%</span>
              </div>
              <div className="font-heading text-[2.25rem] font-extrabold text-text-heading leading-none">23</div>
              <p className="text-[0.78rem] text-text-muted leading-relaxed">Fichas de matrícula en espera de confirmación de requisitos.</p>
            </div>

            <div className="bg-white rounded-xl border border-border p-6 shadow-sm flex flex-col gap-3 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-md border-t-4 border-t-blue-500">
              <div className="flex justify-between items-start gap-2">
                <span className="text-[0.85rem] font-bold text-text-muted uppercase tracking-wider leading-tight">Tasas de Pago Registradas</span>
                <span className="text-[0.75rem] font-bold py-0.5 px-1.5 rounded bg-emerald-100 text-emerald-600">↑ 92%</span>
              </div>
              <div className="font-heading text-[2.25rem] font-extrabold text-text-heading leading-none">S/. 184.2K</div>
              <p className="text-[0.78rem] text-text-muted leading-relaxed">Monto recaudado de pagos verificados por caja institucional.</p>
            </div>

            <div className="bg-white rounded-xl border border-border p-6 shadow-sm flex flex-col gap-3 transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-md border-t-4 border-t-emerald-500">
              <div className="flex justify-between items-start gap-2">
                <span className="text-[0.85rem] font-bold text-text-muted uppercase tracking-wider leading-tight">Secciones Aperturadas</span>
                <span className="text-[0.75rem] font-bold py-0.5 px-1.5 rounded bg-emerald-100 text-emerald-600">↑ 4</span>
              </div>
              <div className="font-heading text-[2.25rem] font-extrabold text-text-heading leading-none">74</div>
              <p className="text-[0.78rem] text-text-muted leading-relaxed">Aulas programadas para el ciclo en curso en diversas facultades.</p>
            </div>
          </>
        )}
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6">
        ...
        <div className="bg-white rounded-xl border border-border p-6 md:p-8 shadow-md">
          <h3 className="font-heading text-[1.25rem] font-extrabold text-text-heading mb-1">📈 {isDirection ? 'Rendimiento Académico por Especialidad' : 'Estado de Trámites y Matrículas'}</h3>
          ...
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">{isDirection ? '15.4' : '85%'}</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">{isDirection ? '14.1' : '70%'}</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">{isDirection ? '14.8' : '78%'}</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">{isDirection ? '13.2' : '62%'}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-border p-6 md:p-8 shadow-md">
          <h3 className="font-heading text-[1.25rem] font-extrabold text-text-heading mb-1">⏱️ {isDirection ? 'Control de Auditoría y Bitácora' : 'Solicitudes Recientes'}</h3>
