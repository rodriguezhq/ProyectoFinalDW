    ...
    <div className="flex flex-col gap-8 animate-slide-up">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1.2fr_0.8fr] gap-6">
        ...
        <div className="bg-white rounded-xl border border-border p-6 md:p-8 shadow-md">
          <h3 className="font-heading text-[1.25rem] font-extrabold text-text-heading mb-1">📈 Estado de Trámites y Matrículas</h3>
          ...
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">85%</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">70%</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">78%</span>
            </div>
            <div className="grid grid-cols-[120px_1fr_50px] gap-4 items-center">
              ...
              <span className="text-[0.88rem] font-bold text-text-heading text-right">62%</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-border p-6 md:p-8 shadow-md">
          <h3 className="font-heading text-[1.25rem] font-extrabold text-text-heading mb-1">⏱️ Solicitudes Recientes</h3>
